        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
            ...
            <CallOutBox type="tip" title="تخطيط الموارد البشرية (مستقبلاً)">
              إن الاعتماد الحالي على استغلال الكفاءات والموارد البشرية المتوفرة يمثل خطة أولية للتشغيل والتحول المبدئي. بعد التشغيل الكامل لنظام الصيانة المركزية واستقرار العمليات، سيقوم المكتب الفني بإجراء تقييم شامل لمستوى الخدمة المقدمة (SLA) والأداء التشغيلي الفعلي لجميع المواقع. وبناءً على هذا التقييم، سيتم تخطيط وإضافة موارد بشرية وفنية إضافية طبقا للاحتياجات الفعلية والتوزيع الجغرافي والمهني المطلوب لضمان أعلى مستويات الخدمة والكفاءة.
            </CallOutBox>
